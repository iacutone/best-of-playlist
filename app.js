...
var _user$project$Port$play = _elm_lang$core$Native_Platform.outgoingPort(
	'play',
	function (v) {
		return v;
	});
var _user$project$Port$pause = _elm_lang$core$Native_Platform.outgoingPort(
	'pause',
	function (v) {
		return v;
	});
...
var _user$project$SongLibrary$songs2017 = {
	...
	_1: {
		ctor: '::',
		_0: {songSource: 'songs/2017/ODESZA - Late Night.webm', songName: 'ODESZA - Late Night', id: 'song2'},
		_1: {
			ctor: '::',
			_0: {songSource: 'songs/2017/Lord Echo - I Love Music.m4a', songName: 'Lord Echo - I Love Music', id: 'song3'},
			_1: {
				ctor: '::',
				_0: {songSource: 'songs/2017/Thundercat - Friend Zone.webm', songName: 'Thundercat - Friend Zone', id: 'song4'},
				_1: {
					ctor: '::',
					_0: {songSource: 'songs/2017/A Giant Dog - Bendover.webm', songName: 'A Giant Dog - Bendover', id: 'song5'},
					_1: {
						ctor: '::',
						_0: {songSource: 'songs/2017/Tanika Charles - Soul Run.webm', songName: 'Tanika Charles - Soul Run', id: 'song6'},
						_1: {
							ctor: '::',
							_0: {songSource: 'songs/2017/Daphni - Tin.webm', songName: 'Daphni - Tin', id: 'song7'},
							_1: {
								ctor: '::',
...
var _user$project$SongLibrary$songs2016 = {
	ctor: '::',
	_0: {songSource: 'songs/2016/The Julie Ruin - I\'m Done.webm', songName: 'The Julie Ruin - I\'m Done', id: 'song1'},
	_1: {
		ctor: '::',
		...
		_1: {
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: {songSource: 'songs/2016/Solange - Cranes in the Sky.webm', songName: 'Solange - Cranes in the Sky', id: 'song5'},
					_1: {
						ctor: '::',
						_0: {songSource: 'songs/2016/Kaytranada - Lite Spots.m4a', songName: 'Kaytranada - Lite Spots', id: 'song6'},
						_1: {
							ctor: '::',
							_0: {songSource: 'songs/2016/Jessy Lanza - It Means I Love You.webm', songName: 'Jessy Lanza - It Means I Love You', id: 'song7'},
							_1: {
								ctor: '::',
								_0: {songSource: 'songs/2016/Badbadnotgood - Time Moves Slow.webm', songName: 'Badbadnotgood - Time Moves Slow', id: 'song8'},
								_1: {
									ctor: '::',
									_0: {songSource: 'songs/2016/Quilt - Roller.webm', songName: 'Quilt - Roller', id: 'song9'},
									_1: {
										ctor: '::',
										_0: {songSource: 'songs/2016/A Tribe Called Quest - The Space Program.mp3', songName: 'A Tribe Called Quest - The Space Program', id: 'song10'},
										_1: {ctor: '[]'}
									}
								}
							}
...
var _user$project$Main$viewTitle = function (title) {
	return A2(
		_elm_lang$html$Html$h2,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('playlist-title'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$Main$viewCircle = function (model) {
	var percentComplete = ((model.duration - model.currentTime) / model.duration) * 100;
	var rInt = 35;
	var radius = _elm_lang$core$Basics$toString(rInt);
	var cInt = 3.14 * (rInt * 2);
	var circumference = _elm_lang$core$Basics$toString(cInt);
	var pctInt = ((100 - percentComplete) / 100) * cInt;
	var pct = _elm_lang$core$Basics$toString(pctInt);
	return A2(
		_elm_lang$svg$Svg$svg,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('circle'),
			_1: {
				ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$id('circle-stroke'),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$cx('40'),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$cy('40'),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$r(radius),
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$stroke('#FA5B19'),
									_1: {
										ctor: '::',
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$svg$Svg_Attributes$strokeDasharray(circumference),
												_1: {
													ctor: '::',
													_0: _elm_lang$svg$Svg_Attributes$strokeDashoffset(pct),
													_1: {ctor: '[]'}
												}
											}
										}
...
var _user$project$Main$animateOpacity = function (browserTime) {
	return A2(
		_mgold$elm_animation$Animation$ease,
		_elm_community$easing_functions$Ease$inQuad,
		A2(
			...
			A2(
				...
				A2(
					...
					1.5 * _elm_lang$core$Time$second,
					_mgold$elm_animation$Animation$animation(browserTime)))));
};
					...
					case '2016':
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									songs: _user$project$SongLibrary$songs2016,
									activePlaylist: true,
									playing: false,
									playlist: _p2,
					...
					case '2017':
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									songs: _user$project$SongLibrary$songs2017,
									activePlaylist: true,
									playing: false,
									playlist: _p2,
									style: _user$project$Main$animateOpacity(model.currentBrowserTime)
			...
			case 'Play':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{playing: true}),
					_1: _user$project$Port$play(model.currentSongId)
				};
			case 'Pause':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{playing: false}),
					_1: _user$project$Port$pause(model.currentSongId)
				};
			case 'UpdateTime':
				return {
					ctor: '_Tuple2',
...
var _user$project$Main$targetId = A2(
	...
	_elm_lang$core$Json_Decode$string);
var _user$project$Main$targetCurrentTime = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'target',
...
var _user$project$Main$onEnd = function (msg) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'ended',
		A2(_elm_lang$core$Json_Decode$map, msg, _user$project$Main$targetId));
};
var _user$project$Main$onTimeUpdate = function (msg) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'timeupdate',
		A2(_elm_lang$core$Json_Decode$map, msg, _user$project$Main$targetCurrentTime));
};
						...
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return {playlist: a, activePlaylist: b, songs: c, currentSongId: d, currentSongName: e, currentTime: f, duration: g, playing: h, position: i, style: j, currentBrowserTime: k};
										};
									};
								};
							};
...
var _user$project$Main$CurrentTick = function (a) {
	return {ctor: 'CurrentTick', _0: a};
};
...
var _user$project$Main$SetSongId = function (a) {
	return {ctor: 'SetSongId', _0: a};
};
var _user$project$Main$SetDuration = function (a) {
	return {ctor: 'SetDuration', _0: a};
};
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Port$setDuration(_user$project$Main$SetDuration),
			_1: {
				ctor: '::',
				_0: _user$project$Port$setSongId(_user$project$Main$SetSongId),
				_1: {
					ctor: '::',
					_0: _user$project$Port$setSongName(_user$project$Main$SetSongName),
					_1: {
						ctor: '::',
						_0: _elm_lang$animation_frame$AnimationFrame$times(_user$project$Main$CurrentTick),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Main$audioSong = function (song) {
	return A2(
		_elm_lang$html$Html$li,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('songs'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(song.songName),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$audio,
					{
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$name(song.songName),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$id(song.id),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$preload('metadata'),
											_1: {ctor: '[]'}
										}
									}
								}
...
var _user$project$Main$viewSongs = function (songs) {
	return A2(
		_elm_lang$html$Html$ul,
		{ctor: '[]'},
		A2(_elm_lang$core$List$map, _user$project$Main$audioSong, songs));
};
var _user$project$Main$Pause = {ctor: 'Pause'};
var _user$project$Main$Play = {ctor: 'Play'};
var _user$project$Main$viewPlayButton = function (playing) {
	return playing ? A2(
		_elm_lang$html$Html$button,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('fa fa-pause btn-circle pause'),
			_1: {
				ctor: '::',
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('fa fa-play btn-circle play'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$name('play'),
				_1: {
					ctor: '::',
...
var _user$project$Main$songActions = function (model) {
	return model.activePlaylist ? A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('song-action-container'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$Main$viewPlaylist = function (model) {
	var opacity = A2(_mgold$elm_animation$Animation$animate, model.currentBrowserTime, model.style);
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _user$project$Main$viewRadioInput = F2(
	function (model, year) {
		return A2(
			_elm_lang$html$Html$div,
			{
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('list-container'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
							...
							_elm_lang$html$Html$input,
							{
								...
								_1: {
									...
									_0: _elm_lang$html$Html_Events$onClick(
										_user$project$Main$Select(year)),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$checked(
											_elm_lang$core$Native_Utils.eq(model.playlist, year)),
										_1: {ctor: '[]'}
									}
								}
							},
						...
						_1: {
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('radio-btn'),
										_1: {ctor: '[]'}
									},
									{ctor: '[]'}),
								_1: {ctor: '[]'}
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('radios'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(_user$project$Main$viewRadioInput, model, '2016'),
							_1: {
								ctor: '::',
					...
					_1: {
						ctor: '::',
						_0: _user$project$Main$viewPlaylist(model),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
